...
class NerProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "mytest1.txt")), "test")
...
def create_model(bert_config, is_training, input_ids, input_mask,
    ...
    blstm_crf = CRF(embedded_chars=embedding, hidden_unit=FLAGS.lstm_size, cell_type=FLAGS.cell, num_layers=FLAGS.num_layers,
...
#         raise ValueError("At least one of `do_train` or `do_eval` must be True.")
    ...
    if FLAGS.do_predict:
        ...
        predict_file = os.path.join(FLAGS.output_dir, "mytest_predict.tf_record")
        ...
        output_predict_file = os.path.join(FLAGS.output_dir, "label_mytest_001.txt")
